...
-keep class com.geocomply.BuildConfig{
    *;
}

-keep class com.geocomply.internal.** { *; }
-keep class com.geocomply.core.** { *; }
-keep class com.geocomply.client.** { *; }
-keep class com.google.** { *; }
-keep class android.support.** { *; }
-keep class com.geocomply.oobeelib.sdk.** {*; }

-keep class com.geocomply.oobeelib.OobeeClient {
    public <methods>;
}

-keep class com.geocomply.oobeelib.OobeeError {
    *;
}

-keep class com.geocomply.oobeelib.BuildConfig {
    *;
}

-keep public interface com.geocomply.oobeelib.IOobeeCallback {
    public <methods>;
}

-keep class ** extends com.geocomply.oobeelib.OobeeException
