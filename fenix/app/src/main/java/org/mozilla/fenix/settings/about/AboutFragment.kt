...
//        binding.aboutText.text = aboutText
        binding.aboutContent.text = "${getString(R.string.app_name)} ${BuildConfig.VERSION_NAME}"
...
//            ),
            ...
            AboutPageItem(
                AboutItem.ExternalLink(
                    AboutItemType.TERM,
                    "https://www.geocomply.com/terms-of-use/"
                ),
        ...
        Do exhaustive when (item) {
            is AboutItem.ExternalLink -> {
                when (item.type) {
                    ...
                    SUPPORT, PRIVACY_NOTICE, LICENSING_INFO, RIGHTS, AboutItemType.TERM -> {} // no telemetry needed
                }
